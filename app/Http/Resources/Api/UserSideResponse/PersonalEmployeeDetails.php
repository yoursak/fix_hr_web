...
class PersonalEmployeeDetails extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'active_employee_id' => $this->active_employee_id ?? '',            // 'date' => $this->date ? date('d-m-Y', strtotime($this->date)) : '',
            'active_employee_name' => $this->active_employee_name ?? '',
            ...
            'emp_reporting_manager' => $this->emp_reporting_manager ?? '',
            'emp_grade' => $this->grade ?? '',
            'emp_budget_code' => $this->budget_code ?? '',
            'emp_account_code' => $this->budget_code ?? '',
            'emp_bank_ifsc_code' => $this->budget_code ?? '',
            'emp_bank_name' => $this->budget_code ?? '',
            'emp_bank_branch_name' => $this->emp_status ?? '',
            'emp_bank_account_no' => $this->bank_account_no ?? '',
            'emp_bank_branch_code'=>$this->bank_branch_code	??'',
            'emp_bank_micr_code'=>$this->bank_micr_code??'',
            'emp_bank_address_line1'=>$this->bank_address_line1??'',
            'emp_bank_address_line2'=>$this->bank_address_line2??'',
