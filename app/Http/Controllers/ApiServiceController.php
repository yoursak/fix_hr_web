...
class ApiServiceController extends BaseController
{
    ...
    public function BusinessDetailsSubmit(Request $request)
    {
        ...
        // $tableName = 'business_details_' . ApiResponse::concatenateFirstCharacters($request->table_name) . '_dyn_' . ApiResponse::getFirstWord($userName);
        // $tableName1 = 'busienss_login_' . ApiResponse::concatenateFirstCharacters($request->table_name) . '_dyn_' . ApiResponse::getFirstWord($userName);
        ...
        // if (!Schema::hasTable($tableName) && !Schema::hasTable($tableName1)) //check business details
        // {
