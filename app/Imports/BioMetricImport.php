                ...
                foreach ($row as $key1 => $value) {
                    if ($key1 >= 4) {
                        ...
                        $EmpData[$EmpId][$day] = [
                            ...
                            'in' => $collection[($EmpCount * 5) + 2][$day + 4],
                            'out' => $collection[($EmpCount * 5) + 3][$day + 4],
                            'WH' => $collection[($EmpCount * 5) + 4][$day + 4],
            ...
            foreach ($Emp as $key => $empData) {
                ...
                if (isset($DATA)) {
                    ...
                    if (isset($information)) {
                        ...
                        //     'today_status' => $TodayStatus[0], 
                        //     'overtime' => $TodayStatus[8],
                        //     'shift_interval' => $TodayStatus[9],
                        //     'early_exit' => $TodayStatus[13],
                        //     'late_by' => $TodayStatus[12],
                        // ]);
