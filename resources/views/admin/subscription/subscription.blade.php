    ...
    <div class="modal-dialog modal-dialog-centered text-center" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Free Demo</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
                                ...
                                <div class="btns mb-5">
                                    <div class="row">
                                        <div class="text-center">
                                            ...
                                            <span class="fs-15 text-muted">Your registered Email Id is:<span class="text-primary mx-1">mustangsteam@fixhr.com</span></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="" style="margin-top: 3rem">
                                        <div class="content my-5">
                                            ...
                                            <div class="pricings freePlan mt-5">
                                                <div class="d-flex justify-content-between py-2" style="border-top: solid 1px rgb(222,226,230)">
                                                    <h5>Total Price :</h5>
                                                    <h5 class="text-end "><i class="fa fa-inr mx-2"></i><span>0</span><br><span class="text-muted fs-12 fw-light">(Inclusive of All
                                                            Texes)</span></h5>
                                                </div>
                                            </div>
                                            <div class="text-start">
                    ...
                    <div class="btns my-5 ">
                        <div class="row">
                            <div class="text-center">
                                ...
                                <span class="fs-16 text-muted">Your registered Email Id is:<span class="text-primary mx-1">mustangsteam@fixhr.com</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="contents">
                                ...
                                <div class="content my-5 mx-4">
                                    <div class="pricings" style="border-bottom: solid 1px rgb(222,226,230)">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <h5 class=" text-end"><i class="fa fa-inr mx-2"></i><span class="ms-auto" id="basePlan">500</span><br><span class="text-muted fs-12 fw-light">For <span class="forPlan">Montly</span></span></h5>
                                        </div>
                                    </div>
                                                ...
                                                <div class="d-block d-xl-flex">
                                                    ...
                                                    <div class="add-employee my-3">
                                                        <ul class="rounded text-center mx-5 d-flex" style="width: 7rem">
                                                            <li class="text-primary border my-auto mx-1 " onclick="operateEmp('minus')">
                                                                <b><i class="fa fa-minus fs-15"></i></b>
                                                            </li>
                                                            <li class=""><input id="empCount" onchange="operateEmp()" value='0' class="fs-15 fw-bold text-center border border-primary border-0 py-1" type="text" style="width:3rem"></li>
                                                            <li class="text-primary border border-5 my-auto mx-1 " onclick="operateEmp('plus')"><b><i class="fa fa-plus fs-15"></i></b></li>
                                                        </ul>
                                                    </div>
                                                </div>

                                                <div class="additionalAmount mt-4 text-end">
                                                    <h5 class="my-auto"><i class="fa fa-inr mx-2"></i><span id="additionalAmmount">0</span><br><span class="text-muted fs-12 fw-light">Per Employee <i class="fa fa-inr"></i> <span id="perEmpPrice">50</span> / <span class="forPlan">Monthly</span></h5>
                                                </div>
                                    ...
                                    <div class="pricings mt-5 totalPriceValue" style="border-bottom: solid 1px rgb(222,226,230);">
                                        <div class="d-flex justify-content-between">
                                            <h5>Total Price : <br><span class="text-muted fs-12 fw-light">For upto 10
                                                    Employee <span class="forPlan">Monthly</span> </span></h5>
                                            <h5 class="text-end"><i class="fa fa-inr mx-2"></i><span id="totalPrice">500</span><br><span class="text-muted fs-12 fw-light">(Inclusive of All Taxes)</span>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="d-flex my-5">
                                        <a class="btn btn-primary mx-auto" href="{{ route('phonepe') }}" style="width: 50%">Make Payment</a>
                    ...
                    <table class="table  table-vcenter text-nowrap table-striped" id="hr-attendance1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center"><a href="#" class="btn btn-sm btn-success">Change Plan</a></td>
                            </tr>
