...
<!-- Added by FixingDots--><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by FixingDots-->
<head>
	...
	<body class="login-img">
				...
				<div class="page responsive-log coming-bg">
					...
					<div class="dropdown custom-layout">
						<div class="demo-icon nav-link  icon  float-end mt-5">
								...
								<div class="col-md-6 d-block mx-auto mb-2">
									<div class="row">
										...
										<div class="col col-auto">
											<div class="fs-18 font-weight-semibold">90%</div>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="progress-wrapper mb-5 col-md-6 d-block mx-auto">
									<div class="progress progress-md">
										<div class="progress-bar-striped progress-bar-animated bg-primary" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div>
									</div>
								</div>
							</div>
