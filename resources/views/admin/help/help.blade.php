    ...
    <div class="page responsive-log coming-bg">
        ...
        <div class="page-content p-7 m-0">
            <div class="container text-center">
                ...
                <p class="h5 font-weight-normal mb-4 leading-normal">You may have mistyped the address or the page may
                    have moved.</p>
                <div class="row">
                ...
                <div class="row">
                    <div class="progress-wrapper mb-5 col-md-6 d-block mx-auto">
                        <div class="progress progress-md">
                            <div class="progress-bar-striped progress-bar-animated bg-primary" role="progressbar"
