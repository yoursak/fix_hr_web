...
<div class="iniitial-header my-5">
    ...
    <span class="fs-16">
        <span class=""><i class="fa fa-check-circle mx-2 text-primary"></i>Account Settings<i class="fa fa-angle-right my-auto mx-2"></i></span>
        <span class=""><i class="fa fa-check-circle mx-2 text-primary"></i>Business Settings<i class="fa fa-angle-right my-auto mx-2"></i></span>
        <span class=""><i class="fa fa-check-circle mx-2 text-primary"></i>Attendance Settings<i class="fa fa-angle-right my-auto mx-2"></i></span>
        <span class=""><i class="fa fa-circle mx-2 text-primary"></i>Setup Activation<i class="fa fa-angle-right my-auto mx-2"></i></span>
        <span class="text-muted"><i class="fa fa-circle mx-2"></i>Subscription<i class="fa fa-angle-right my-auto mx-2"></i></span>
        <span class="text-muted"><i class="fa fa-circle mx-2"></i>Add Employee<i class="fa fa-angle-right my-auto mx-2"></i></span>
        <span class="text-muted"><i class="fa fa-circle mx-2"></i>Finish<i class="fa fa-angle-right my-auto mx-2"></i></span>
    </span>
</div>
<?php
...
<div class="row">
                                    ...
                                    <div class="row justify-content-center align-items-center g-2">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Setup Name <span class="text-red">*</span></label>
                                                <input type="text" class="form-control" name="methodname" id="" placeholder="Setup Name" required>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                <label class="form-label">Policy Preference <span class="text-red">*</span></label>
                                                <select id="policypreference" name="policypreference" onchange="LoadPolicyPreference(this)" class="form-control select2 custom-select" data-placeholder="Choose Policy Preference" required>
                                        ...
                                        <div class="col-md-4" id="businessleavel">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="" name="b_id" value="<?= session('business_id') ?>" hidden>
                                                <input type="text" class="form-control" name="businessname" id="" placeholder="Business Name Default" value="<?= $BusinessDetails->business_name ?>" disabled required>
                                            </div>
                                        </div>

                                        <div class="col-md-4" id="branchleavel">
                                            <div class="form-group ">
                                                <label class="form-label">Branch Level <span class="text-red">*</span></label>
                                                <select class="form-control select2" name="branhcid[]" data-placeholder="Choose Leave Policy" multiple>
                                                    @php
                                                    $no = 1;
                                                    @endphp
                                                    @empty(!$BranchList)
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-label">Shift Settings <span class="text-red">*</span></label>
                                                <select class="form-control select2 custom-select" name="shiftsetting[]" data-placeholder="Choose Shift Policy" multiple required>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group ">
                                                <label class="form-label">Leave Policy <span class="text-red">*</span></label>
                                                <select class="form-control select2 custom-select" id="leavepolicy" name="leavepolicy" data-placeholder="Choose Leave Policy" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-label"> Holiday Policy <span class="text-red">*</span></label>
                                                <select class="form-control select2" name="holidaypolicy" data-placeholder="Choose Holiday Policy" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-label"> Weekly Policy <span class="text-red">*</span></label>
                                                <select class="form-control select2" name="weeklypolicy" data-placeholder="Choose Weekly Policy" required>
            ...
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="d-flex">
                    ...
                    <div class="btn-list d-flex">
                        <a class="modal-effect btn btn-primary mx-3 ms-auto" data-effect="effect-scale" data-bs-toggle="modal" href="#additionalModals" id="btnOpen">Create Setup</a>
                    </div>
                    @endif
                </div>
            </div>
                    ...
                    <table class="table  table-vcenter text-nowrap  border-bottom ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-xl-3 pe-0">
                                        ...
                                        <label class="custom-switch">
                                            <input type="checkbox" id="custom-switch-checkbox" onclick="callBack('{{ $item->business_id }}', '{{ $item->id }}','{{ $item->holiday_policy_ids_list }}','{{ $item->weekly_policy_ids_list }}')" name="custom-switch-checkbox" class="custom-switch-input custom-switch-checkbox" <?= $item->method_switch !== 0 ? 'checked' : '' ?>>
                                ...
                                <td>
                                    @if (in_array('Setup Activation.Update', $permissions) || in_array('Setup Activation.All', $permissions))
                                    <a class="btn btn-primary btn-icon btn-sm" href="javascript:void(0);" onclick="openEditMasterPolicy(this)" data-id='<?= $load_id ?>' data-b_id='<?= $item->business_id ?>' data-switch='<?= $item->method_switch ?? false && $item->method_switch != 0 ? $item->method_switch : 0 ?>' data-bs-toggle="modal" data-bs-target="#editMasterCreated">
                                    ...
                                    <a class="btn btn-danger btn-icon btn-sm" href="javascript:void(0);" onclick="DeleteMasterModel(this)" data-ids='<?= $load_id ?>' data-b_id='<?= $item->business_id ?>' data-loaded='<?= $method_name ?? false ? $method_name : '' ?>' data-bs-toggle="modal" data-bs-target="#editdeleteModal">
                                        <i class="feather feather-trash" data-bs-toggle="tooltip" data-original-title="View/Edit"></i>
                                    </a>
                                    @endif
                ...
                <div class="modal-content">
                    <form id="modalForm">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-secondary" id="cancelButton" onclick="loadedCall(this)" type="reset" value="1" data-bs-dismiss="modal">Cancel</button>
                            <button class="btn btn-danger" onclick="loadedCall(this)" value="0" type="submit">Deactivated</button>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-center align-items-center g-2">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Setup Name <span class="text-red">*</span></label>
                                                <input type="text" class="form-control" name="edit_mname" id="edit_mname" placeholder="Setup Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                <label class="form-label">Policy Preference <span class="text-red">*</span></label>
                                                <select id="editpolicypreference" name="editpolicypreference" onchange="LoadPolicyPreference(this)" class="form-control select2 custom-select" data-placeholder="Choose Policy Preference" aria-readonly="true" required>
                                                    <option label="Choose Policy Preference">
                                                    </option>
                                                    <option value="1" selected>Business Level</option>
                                                    {{-- <option value="2">Employee Level</option> --}}
                                        ...
                                        <div class="col-md-4" id="editbusinessleavel">
                                            <div class="form-group ">
                                                <label class="form-label">Business Name <span class="text-red">*</span> </label>
                                                <input type="text" id="b_id" name="b_id" value="<?= session('business_id') ?>" hidden>
                                                <input type="text" class="form-control" name="businessname" id="" placeholder="Business Name Default" value="<?= $BusinessDetails->business_name ?>" readonly required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4" id="editbranchleavel">
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control select2" name="editbranhcid[]" data-placeholder="Choose Leave Policy" multiple>
                                                    @php
                                                    $no = 1;
                                                    @endphp
                                                    @empty(!$BranchList)
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-label">Shift Settings <span class="text-red">*</span></label>
                                                <select class="form-control select2" id="editshiftsetting" name="editshiftsetting[]" data-placeholder="Choose Shift Policy" multiple required>
                                                    @php
                                                    $no = 1;
                                                    @endphp
                                                    @empty(!$attendanceShiftPolicy)
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group ">
                                                <label class="form-label">Leave Policy <span class="text-red">*</span></label>
                                                <select class="form-control select2 custom-select" id="editleavepolicy" name="editleavepolicy" data-placeholder="Choose Leave Policy" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group ">
                                                <label class="form-label">Holiday Policy <span class="text-red">*</span></label>
                                                <select class="form-control select2 custom-select" id="editholidaypolicy" name="editholidaypolicy" data-placeholder="Choose Holiday Policy" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group ">
                                                <label class="form-label">Weekly Policy <span class="text-red">*</span></label>
                                                <select class="form-control select2 custom-select" id="editweeklypolicy" name="editweeklypolicy" data-placeholder="Choose Weekly Policy" required>
    ...
    <div class="modal fade" id="editdeleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
...
<div class="d-flex justify-content-between">
    ...
    <div class="d-flex">
                    <a href="{{ url('/setup/employee') }}" class="btn btn-primary">Save & Continue</a>
    </div>
</div>
