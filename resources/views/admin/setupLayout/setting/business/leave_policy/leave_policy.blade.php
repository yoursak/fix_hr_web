...
@section('content')
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn action-btns  btn-primary btn-icon btn-sm" href="javascript:void(0);"
                                        ...
                                        data-sandwich_leaves_count='<?= $item->sandwich_leaves_count ?>'
                                        data-sandwich_leaves_ignore='<?= $item->sandwich_leaves_ignore ?>'
                                    ...
                                    <a class="btn action-btns  btn-primary btn-icon btn-sm" href="javascript:void(0);"
                                        onclick="openViewModel(this)" data-id='<?= $item->id ?>'
                    ...
                    <form action="{{ route('admin.leavepolicySubmit') }}" method="POST" id="form_leave">
                        <div class="modal-body" style="height: 60vh; overflow:scroll">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-10">
                                    <input type="text" class=" form-control " id="policy_Names"
                            ...
                            <div class="pt-2 row">
                                ...
                                <div class="col-xl-2">
                                    <input type="month" class="form-control " name="leave_periodfrom" id="editFrom"
                                        data required>
                                </div>
                                <label class="col-xl-1 text-xl-center col-form-label" for="form-label">To</label>
                                <div class="col-xl-2">
                                    <input type="month" class="form-control" name="leave_periodto" id="editTo"
                                        required readonly>
                                </div>
                            </div>
                            ...
                            <div class="pt-2 row">
                                <label for="inputPassword" class="col-xl-2 col-form-label">Sandwich Leaves
                                    <small class="badge badge-info-light" data-bs-trigger="hover"
                                        style="background-color:transparent;" data-bs-container="body"
                                        data-bs-content="When a holiday falls between two taken leaves, they are merged together and considered as sandwich leaves."
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="height: 60vh; overflow:scroll">
                        ...
                        <div class="row">
                            <label for="inputPassword" class="col-sm-2 col-xl-2 col-form-label">Policy Name</label>
                            <div class="col-xl-10">
                                <input type="text" class="form-control " name="edit_policys" id="edit_policyview"
                                    placeholder="Enter Leave Policy Template Name" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="pt-2 row">
                            <label for="editFrom" class="col-xl-2 col-form-label">Leave Period</label>
                            <div class="col-xl-2">
                                <input type="month" class="form-control " id="leave_periodfrom2view"
                                    aria-disabled="true" disabled>
                            </div>
                            <label class="col-xl-1 col-form-label text-xl-center" for="">To</label>
                            <div class="col-xl-2">
                                <input type="month" class="form-control " id="leave_periodto2view"
                                    aria-disabled="true" disabled>
                            </div>
                        ...
                        <div class="pt-2 row">
                            <label for="inputPassword" class="col-xl-2 col-form-label">Sandwich Leaves <small
                                    ...
                                    style="background-color:transparent;" data-bs-container="body"
                                    data-bs-content="When a holiday falls between two availed leaves, they are merged together and considered as sandwich leaves."
                                    data-bs-placement="right" data-bs-popover-color="primary" data-bs-toggle="popover"
                                    data-bs-html=true title="Sandwich Leaves"><i class="fa fa-info-circle"></i></small>
                            </label>
                            <div class="col-sm-5">
                                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" class="btn-check" value="1" name="btnradioedit"
                                        id="btnradiomonthseditview" disabled>
                                    <label class="btn btn-outline-primary px-4" for="btnradiomonthseditview">Count</label>
                                    <input type="radio" class="btn-check" value="2" name="btnradioedit"
                                        id="btnradioyearseditview" disabled>
                                    <label class="btn btn-outline-primary px-4" for="btnradioyearseditview"
                                        style="width: 5.8rem">Ignore&nbsp;&nbsp;&nbsp;</label>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function checkMaxValue(context) {
            ...
            // Update validation status for the current row
            // validationStatus[id] = !(myButton.disabled || dayErr1.classList.contains('d-none'));
    ...
    <script>
        ...
        function LeaveCategoryCheckEdit1(context) {
            ...
            var applicableTo = document.getElementById('applicable_to_edit1' + id);
            applicableTo.innerHTML = '';
            unusedLeaveRuleDropdown.innerHTML = '';
            leaveCycleDropdown.innerHTML = '';
        ...
        function appendViewFormItem(item) {
            ...
            var newItemHtml = `<div class="row rowrowedit" disabled>
                    ...
                    <div class="col-xl-2 pt-3"> 
                        <label for="inputState" class="form-label">Applicable To</label> 
                        <select class="form-control select2" data-id="${id}" id="applicable_to_edit${id}" name="applicable_to_edit[]" data-placeholder="Applicable To" required disabled> 
