...
@if (in_array('Attendance Setting.All', $permissions) ||
    ...
    @section('content')
        ...
        <div class="row pt-3">
                        ...
                        <div class="d-flex">
                            @if (in_array('Shift Settings.All', $permissions) || in_array('Shift Settings.Create', $permissions))
                                <div class="btn-list d-flex">
                                    <button class="modal-effect btn btn-primary btn-block mx-3" data-effect="effect-scale"
                                        data-bs-toggle="modal" id="btnOpen">Create shift</button>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                        <div class="modal-content">
                            <div class="modal-header p-5">
                                <h5 class="modal-title" id="exampleModalLongTitle" style="font-size:18px;">Edit Fixed Shift
                                    Policy
                                </h5>
            ...
            <div class="container">
                <div class="modal fade" id="openshiftModel" data-bs-backdrop="static">
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                        <div class="modal-content">
                            <div class="modal-header p-5">
            ...
            <script>
                ...
                function openTimeCalculate() {
                    console.log("jii");
                    // let update_shift_name = document.getElementById("editshift_tname").value;
                    let upate_shift_hour = document.getElementById("editshift_hour").value;
                    let update_shift_min = document.getElementById("editshift_min").value;
                    let update_shift_brack = document.getElementById("editshift_breack").value;
                }
            ...
            <div class="modal fade" id="additionalModal" data-bs-backdrop="static">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('add.shift') }}" method="post" id="addShiftId">
                            @csrf
                            <div class="modal-body">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="form-group d-none" id="shiftname2">
                                            ...
                                            <div class="row" id="newRotationalField0">
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <span id="rot_fixedWorkHour0"
                                                        class="mb-5 fs-12 text-muted rotationalShiftCreateClass"></span>
                                                </div>
                                            </div>
                                            ...
                                            <script>
                                                ...
                                                function addRotationalField() {
                                                    ...
                                                    let rotationalShift = '<div class="row show_item_insert" id="newRotationalField' + i + '">' +
                                                        ...
                                                        '</div>' +
                                                        '</div>' +
                                                        '<span id="rot_fixedWorkHour' + i + '" class="mb-5 fs-12 text-muted rotationalShiftCreateClass"></span>' +
                                                        '</div>' +
                                                        '</div>';
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-danger" type="reset" id="createShiftCancelBtn"
        ...
        <div class="d-flex justify-content-between">
            <div>
                <a href="{{ url('/setup/attendance-settings') }}" class="btn btn-primary">Back</a>
            </div>
