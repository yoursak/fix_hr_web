...
@section('content')
    <div class="iniitial-header m-5">
        ...
        <span class="fs-16">
            <span class=""><i class="fa fa-circle mx-2 text-primary"></i>Account Setting<i
                    class="fa fa-angle-right my-auto mx-2"></i></span>
            <span class="text-muted"><i class="fa fa-circle mx-2"></i>Business Setting<i
                    class="fa fa-angle-right my-auto mx-2"></i></span>
                ...
                <div class="modal-content tx-size-sm">
                    ...
                    <form method="post" action="{{ route('saddress.update', $accDetail->id) }}">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" placeholder="Pin Code" id="" name="pincode"
            ...
            aria-hidden="true">&times;</span></button>
                ...
                <form method="post" action="{{ route('saddress.update', $accDetail->id) }}">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="mb-0 pb-0 text-dark fs-13 mt-2 ">Pin Code</p>
                        <input class="form-control" placeholder="Pin Code" id="updatePinCode" name="pincode"
                            id="" type="text" value="" required>
