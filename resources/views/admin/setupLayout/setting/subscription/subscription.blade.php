                                            ...
                                            <div class="" style="margin-top: 3rem">
                                                <div class="content my-5">
                                                    <div class="pricings">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="text-start">
                                                                ...
                                                                <br><span class=" fs-12">For upto 5 Employee for 5
                                                                    Days</span>
                                                            </div>
                                                    ...
                                                    <div class="d-flex mt-5">
                                                        <a class="btn btn-primary mx-auto" style="width: 50%">Activate
                                                            Demo</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-6 mx-auto" style="border:rgb(222,226,230) solid 2px">
                                        <div class="d-flex justify-content-center my-5 pb-5">
                                            <ul class=" border border-primary  rounded">
                                                ...
                                                <input type="text" class="base_plans" name="baseplans" value="500"
                                                    hidden>
                                                <input type="text" class="per_mployee" name="peremployee" value="0"
                                                    hidden>
                                                <input type="text" class="" name="totalamount" value="0"
                                                    hidden>

                                                <input type="text" class="additional_mployee"
                                                    name="additionalemployee" value="0" hidden>
                                                ...
                                                <li id="halfBtn" class="btn rounded " value="6"
                                                    onclick="changePlan(6)">

                                                    <b>Half Yearly</b>

                                                </li>
                                                <li id="annuallyBtn" class="btn rounded " value="12"
                                        ...
                                        <div class="content my-5 mx-4">
                                            <div class="pricings" style="border-bottom: solid 1px rgb(222,226,230)">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <h5 class=" text-end"><i class="fa fa-inr mx-2"></i><span
                                                            class="ms-auto" id="basePlan">500</span><br><span
                                            ...
                                            <div class="pricings mt-5 totalPriceValue"
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <h5>Total Price : <br><span class="text-muted fs-12 fw-light">For upto
                                                            10
                            ...
                            <table class="table  table-vcenter text-nowrap  border-bottom " id="">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center border-bottom-0 ">Plan Duration</th>
                                ...
                                <tbody>
                                    {{-- <tr>
                                        ...
                                        <td class="text-center">
                                            @if (in_array('Subscription.Update', $permissions))
                                                <a href="#" class="btn btn-sm btn-success">Change
                                                    Plan</a>
                                            @endif
                                        </td>
                                    </tr> --}}
                                    {{-- @php
                                        dd($subscriptionTable);
                                    @endphp --}}
            ...
            <div class="modal-dialog modal-dialog-top  modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <form action="{{ url('response') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <iframe id="iframeModalWindow" height="900" width="80%" src=""
