            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="row mx-3">
                            <div class="col-7">
                                <div class="mt-0 text-start"> <span class="font-weight-bold">Pending</span>
                                    <h3 class="mb-0 mt-1 text-secondary">5,678</h3>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="icon1 my-auto  float-end"> <img src="{{asset('imgs/pending.gif')}}" alt="" height="70px" width="70px">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="row mx-3">
                            <div class="col-7">
                                <div class="mt-0 text-start"> <span class="font-weight-bold">Frozen</span>
                                    <h3 class="mb-0 mt-1 text-primary">1,396</h3>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="icon1  my-auto  float-end">
                                    <img src="{{asset('imgs/hold1.gif')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-12 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="row mx-3">
                            <div class="col-7">
                                <div class="mt-0 text-start"> <span class="font-weight-bold">Processed</span>
                                    <h3 class="mb-0 mt-1 text-success">3,876</h3>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="icon1 my-auto  float-end"> <img src="{{asset('imgs/check.gif')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">Net Payment</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="badge badge-orange-light">Hold</span></td>
