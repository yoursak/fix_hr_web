                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if (in_array('Camera Permission.Update', $permissions))
                                                    <a class="btn btn-primary btn-icon btn-sm" id="edit_btn_modal"
                                                        onclick="openEditModel(this)" data-id='{{ $camera->id }}'
                                                        data-branch_id='{{ $camera->branch_id }}' ,
                                                        data-modecheck='{{ $camera->mode_check }}' ,
                                                        data-branchmail='{{ $camera->branch_email }}' ,
                                                        data-typecheck='{{ $camera->type_check }}' ,
                                                        data-imeino='{{ $camera->imei_number }}'
                                                        data-checkcamera='{{ $camera->check_camera }}'
                                                        data-bs-toggle="modal" data data-bs-target="#updateCameraAccess">
                            ...
                            <div class="row mx-2">
                                <div class="my-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="">
                                            <select class="form-control " name="mode" data-placeholder="Choose One"
                                                required>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="">
                                            <select class="form-control" name="type" data-placeholder="Choose One"
                                                required>
                                                <option value="" disabeld>Select Login Type</option>
                                ...
                                <div class="my-2">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" name="branch_email" id="branchEmail"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" name="imei" class="form-control" value=""
                                                placeholder="eg. 12548935154562" maxlength="15" required>
                            ...
                            <div class="row mx-2">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="">
                                            <select class="form-control select2" name="type"
                                                ...
                                                @foreach ($Type as $type)
                                                    <option label="Choose one" value="{{ $type->id }}">
                                                        {{ $type->mode_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="">
                                    <div class="form-group">
                                        <label class="form-label">Branch Email</label>
                                        <div class="">
                                            <input type="text" name="update_branch_email" id="ubranchEmail"
                                                class="form-control text-muted" placeholder="" readonly>
                                        </div>
                                    </div>
                                </div>
