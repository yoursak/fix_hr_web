                            ...
                            <div class="card-header border-0">
                                ...
                                <label class="custom-switch ms-auto">
                                    <input type="checkbox" name="premisesActive" onchange="globalCondition()"
                                        id="isOffice" class="custom-switch-input" <?php echo ($Modes->office_auto != 0
                                    || $Modes->office_manual != 0) ? 'checked' : ''; ?>>
                                        ...
                                        <div class="d-flex mt-2">
                                            <label class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input"
                                                    ...
                                                    value="1" <?php echo ($Modes->office_auto != 0) ? 'checked' : '';
                                                ?>>
                                            ...
                                            <label class="custom-control custom-radio mx-1">
                                                <input type="radio" class="custom-control-input"
                                                    ...
                                                    value="0" <?php echo ($Modes->office_manual != 0) ? 'checked' : '';
                                                ?>>
                                            ...
                                            <div class="d-flex">
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        ($Modes->office_face_id != 0) ? 'checked' : ''; ?>>
                                                    <span class="custom-control-label"></span>
                                                </label>
                            ...
                            <div class="card-header border-0">
                                ...
                                <label class="custom-switch ms-auto">
                                    <input type="checkbox" name="outDoorActive" onchange="globalCondition()"
                                        id="isOutDoor" class="custom-switch-input" <?php echo ($Modes->outdoor_auto != 0
                                    || $Modes->outdoor_manual != 0) ? 'checked' : ''; ?>>
                                    <span class="custom-switch-indicator"></span>
                                </label>
                            </div>
                                        ...
                                        <div class="d-flex mt-2">
                                            <label class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input"
                                                    ...
                                                    <?php echo ($Modes->outdoor_auto != 0) ? 'checked' : ''; ?>>
                                                <span class="custom-control-label">Auto</span>
                                            </label>
                                            &nbsp;&nbsp;
                                        ...
                                        <div class="d-flex">
                                            <label class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" name="outSelfie"
                                                    id="outSelfie" value="1" <?php echo ($Modes->outdoor_selfie != 0) ?
                                                'checked' : '';?>>
                                                <span class="custom-control-label"></span>
                                            </label>
                            ...
                            <div class="card-header border-0">
                                ...
                                <label class="custom-switch ms-auto">
                                    <input type="checkbox" name="wfhActive" onchange="globalCondition()"
                                        class="custom-switch-input" id="isWFH" <?php echo ($Modes->wfh_auto != 0 ||
                                    $Modes->wfh_manual != 0) ? 'checked' : ''; ?>>
                                    <span class="custom-switch-indicator"></span>
                                </label>
                            </div>
                                    ...
                                    <div class="d-flex mt-2">
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input"
                                                ...
                                                <?php echo ($Modes->wfh_auto != 0) ? 'checked' : '';?>>
                                            <span class="custom-control-label">Auto</span>
                                        </label>
                                        &nbsp;&nbsp;
                                        ...
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input"
                                                ...
                                                <?php echo ($Modes->wfh_manual != 0) ? 'checked' : '';?>>
                                            <span class="custom-control-label">Manual</span>
                                        </label>
                                    </div>
                                        ...
                                        <div class="d-flex">
                                            <label class="custom-control custom-checkbox ">
                                                <input type="checkbox" class="custom-control-input" name="wfhSelfie"
                                                    id="wfhSelfie" value="1" <?php echo ($Modes->wfh_selfie != 0) ?
                                                'checked' : '';?>>
                                                <span class="custom-control-label"></span>
                                            </label>
