                    ...
                    <div class="col-10 d-flex justify-content-between">
                        ...
                        <div class="my-auto"><a href="#">
                            ...
                            <p class="my-auto">
                                ...
                                if ($attendaceMode[0]->in_premises_auto != 0 || ($attendaceMode[0]->in_premises_qr != null || $attendaceMode[0]->in_premises_face_id != null || $attendaceMode[0]->in_premises_selfie != null) ) {
                                    echo "<b>Office </b>";
                                ...
                                }else if ($attendaceMode[0]->outdoor_auto != 0 || ($attendaceMode[0]->outdoor_selfie != null) ) {
                                ...
                                }else if ($attendaceMode[0]->wfh_auto != 0 || ($attendaceMode[0]->outdoor_selfie != null) ) {
                                    echo "<br><b>Remote </b>";
                                    
                                    if ($attendaceMode[0]->wfh_auto != 0) {
                                        echo "Employee with Auto Attendance";
                                        echo ($attendaceMode[0]->wfh_auto != 0) ? 'Mark Present By Default' : '';
                                    }
                                
                                    if ($attendaceMode[0]->wfh_selfie != null ) {
                                        echo ($attendaceMode[0]->wfh_selfie != 0) ? 'Manual  Selfie & Geo Location' : '';
                                    }
                                }
                                else {
                        ...
                        <div class="my-auto"><a href="#" data-bs-target="#attMode" data-bs-toggle="modal"><i
                        ...
                        <div class="card">
                            ...
                            <div class="card-header border-0">
                                ...
                                <label class="custom-switch ms-auto">
                                    ...
                                    <input type="checkbox" name="premisesActive" onchange="inPremises()" id="isPremises"
                                    ...
                                    <div class="row">
                                        <div class="d-flex mt-2">
                                            <label class="custom-control custom-radio">
                                                ...
                                                <input type="radio" class="custom-control-input" onchange="inPremises()"
                                                    name="premisesIsAuto" id="premisesAuto" value="1" checked>
                                                <?php }else{ ?>
                                                <input type="radio" class="custom-control-input" onchange="inPremises()"
                                                    name="premisesIsAuto" id="premisesAuto" value="1">
                                                <?php } ?>
                                            ...
                                            <label class="custom-control custom-radio mx-1">
                                                ...
                                                <input type="radio" class="custom-control-input" onchange="inPremises()"
                                                    name="premisesIsAuto" id="premisesManual" value="0" checked>
                                                <?php }else{ ?>
                                                <input type="radio" class="custom-control-input" onchange="inPremises()"
                                                    name="premisesIsAuto" id="premisesManual" value="0">
                                                <?php } ?>
                                                ...
                                                <div class="d-flex">
                                                    <label class="custom-control custom-checkbox">
                                                        ...
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="premisesDefault" id="premisesDefault" value="1"
                                                            checked>
                                                        <?php }else{ ?>
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="premisesDefault" id="premisesDefault" value="1">
                                                ...
                                                <div class="d-none" id="premisesManualContent">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <label class="custom-control custom-checkbox">
                                                            ...
                                                            <input type="checkbox" class="custom-control-input"
                                                                name="premisesQR" id="premisesQR" value="1" checked>
                                                            <?php }else{ ?>
                                                            <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        <div class="d-none" id="outAutoContent">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <label class="custom-control custom-checkbox ">
                                                                    <?php if (($Modes!=null) && $Modes->outdoor_auto == 1) { ?>
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="outDefault" id="outDefault" value="1"
                                                                        checked>
                                                                    <?php }else{ ?>
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="outDefault" id="outDefault" value="1">
                                                                ...
                                                                <label class="form-label mx-1">Mark Present By Default
                                                                    <br> <span class="fs-12 fw-light text-muted">Default
                                                                        Auto Present can
                                                                        be
                                                                        changed
                                                                        Manually</span></label>
                                                                ...
                                                                <div class="d-flex">
                                                                    <label class="custom-control custom-checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            ...
                                                                            name="outSelfie" id="outSelfie" value="1"
                                                                            checked>
                                                                        <?php }else{ ?>
                                                                        <input type="checkbox"
                                                                            class="custom-control-input"
...
<div class="modal fade" id="ioModal">
    <div class="modal-dialog" role="document">
        <?php    $Track = DB::table('attendance_track_in_out')->where('business_id', Session::get('business_id'))->first();
        ?>
                                    ...
                                    <div class="col-xl-1 pe-0">
                                        <label class="custom-switch">
                                            <input type="checkbox" name="tranck_in_out" class="custom-switch-input"
                                                value="1" @if($Track->track_in_out) checked @endif>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-1 pe-0">
                                        <label class="custom-switch">
                                            <input type="checkbox" name="no_attendace_with_punch"
                                                ...
                                                @if($Track->no_attendace_without_punch) checked @endif>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                </div>
