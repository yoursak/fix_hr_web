        ...
        <div class="card-body border-bottum-0">
            <div class="row">
                <div class="col-xl-3 my-auto">
                    <h5 class="my-auto">Jasmit Bhasin</h5>
                </div>
                <div class="col-xl-3 my-auto">
                    <p class="my-auto" style="color:rgb(34, 33, 29)"><i class="fe fe-mail mx-2"></i>jbhasin@fixingdots.com</p>
                </div>
                <div class="col-xl-3 my-auto">
...
<div class="row">
    <div class="card">
        ...
        <div class="card-body border-bottum-0">
            <div class="row">
                <div class="col-xl-3 my-auto">
                    <h5 class="my-auto">Anjali Shriwastava</h5>
                </div>
                <div class="col-xl-3 my-auto">
                    <p class="my-auto" style="color::rgb(34, 33, 29)"><i class="fe fe-mail mx-2"></i>hr@fixingdots.com</p>
                </div>
                <div class="col-xl-3 my-auto">
