                    ...
                    <div class="row">
                        <div class="col-md-12 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="search" class="form-control header-search" placeholder="Enter Template"
                                ...
                                <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                                    <div class="btn-list d-flex">
                                        <a class="modal-effect btn btn-block mb-3" data-effect="effect-scale"
                                            data-bs-toggle="modal" href="#addempmodal"><b class="text-primary">Add New
                                                Holiday</b></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 col-xl-2">
                            <p class="my-auto text-muted">
                                <a class="btn text-primary" id="manageemp1" href="#"><b>Manage Employee
                                        List</b></a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="search" class="form-control header-search" placeholder="Search Template"
                                    aria-label="Search" tabindex="1">
                            </div>
                        </div>
                        <div class="col-md-12 col-xl-6">
