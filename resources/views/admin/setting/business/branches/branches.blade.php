                        ...
                        <div class="col-xl-3">
                            <p class="my-auto text-muted text-end">
                                <a href="javascript:void(0);" class="action-btns" data-bs-toggle="modal"
                                    data-bs-target="#editBranchName{{$item->branch_id}}" id="BranchEditbtn" title="Edit">
                                    <i class="feather feather-edit  text-dark"></i>
                                </a>
                                <a href="javascript:void(0);" class="action-btns" data-bs-toggle="modal"
                                    data-bs-target="#branchDeletebtn{{$item->branch_id}}" id="BranchEditbtn" title="Edit">
...
@foreach ($branch as $item)
{{-- Edit Branch Name --}}
<div class="modal fade" id="editBranchName{{$item->branch_id}}">
    {{-- @dd($item->branch_name) --}}
        ...
        <div class="modal-content tx-size-sm">
            ...
            <div class="modal-body">
                <div class="col-lg">
                    ...
                    <input class="form-control" placeholder="Business Name" type="text" value="{{$item->branch_name}}">
...
@foreach($branch as $item)
<div class="modal fade" id="branchDeletebtn{{$item->branch_id}}" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{route('delete.branch',$item->branch_id)}}">
                    @csrf
