...
@if (in_array('Report.View', $permissions))
    @section('contents')
        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-11 my-auto">
                            ...
                            <p class="my-auto fs-14 mt-1 text-muted" style="color:rgb(34, 33, 29)">
                                Attendance Report, Daily Attendance Report, Leave Balance Report and Attendance Summary
                                Report,
                                Muster Roll Report
                            </p>
                        </div>
                        <div class="col-1 my-auto text-end">
                            <i class="fe fe-chevron-right text-primary fs-30 btn " id="reportBtn1"></i>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card" id="contentCard1">
                ...
                <div class="card-body border-bottum-0 m-3">
                    <div class="row">
                        <div class="col-7 my-auto">
                            <h5 class="my-auto">Individual Employee Attendance Report With GeoLocation And Selfie</h5>
                            <p class="my-auto fs-14 mt-1 text-muted" style="color:rgb(34, 33, 29)">
                                Monthly view of day wise attendance details with GeoLocation and Selfie of individual Employee.
                            </p>
                        </div>
                        <div class="col-5 my-auto text-end">
                            <button type="button" class="btn btn-primary my-2" data-bs-toggle="modal"
                                data-bs-target="#reportWithGeoLocation" id="newTempFormBtn3"><i
                                    class="fa fa-file-excel-o me-2"></i>Download</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="card" id="repoerCard3">
                <div class="card-body border-bottum-0">
                    <div class="row">
                        ...
                        <div class="col-1 my-auto text-end">
                            <i class="fe fe-chevron-right text-primary fs-30 btn " id="reportBtn3"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form action="{{ route('export.LeaveMusterRoll', ['id' => 1]) }}" method="post">
            ...
            <div class="modal fade" id="LeaveMusterRoll" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered text-center" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Leave Report Muster Roll Report</h6><a aria-label="Close"
                                class="btn-close" data-bs-dismiss="modal" type="reset"><span aria-hidden="true"
                                    type="button">&times;</span></a>
                        </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="custom-controls-stacked d-flex">
                                    <label class="custom-control custom-radio mx-3">
                                        <input type="radio" class="custom-control-input" name="export" value="2"
                                            onchange="changeEvent1(this.value)">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" type="submit" data-bs-dismiss="modal" id="LeaveMusterRollExportBtn"
                        disabled>Export</button>
                </div>
                <script>
                    function changeEvent1(e) {
                        var btnElement = document.getElementById('LeaveMusterRollExportBtn');
                        console.log(e, btnElement);
                    }
                </script>
            </div>
        </form>
        ...
        <form action="{{ route('export.LeaveMusterRollReport') }}" method="post">
            ...
            <div class="modal fade" id="leaveExportMusterRoll" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered text-center" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Employee Leave Muster Roll Report</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="reset" id="leaveExportMusterRollReportCloseBtn" onclick="changeEvent2('off')"><span aria-hidden="true"
                                    type="button">&times;</span></button>
                        </div>
                        <div class="modal-body">
                            <div class="row text-start">
                                <div class="col-md-12">
                                        ...
                                        <div class="custom-controls-stacked d-flex">
                                            <label class="custom-control custom-radio mx-3">
                                                <input type="radio" class="custom-control-input" name="export1"
                                                    onchange="changeEvent2(this.value)">
                                                <span class="custom-control-label"><b>Excel</b></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary" type="submit" data-bs-dismiss="modal"
                                id="leaveExportMusterRollReportBtn" disabled>Export</button>
                        </div>
                    </div>
                </div>
                <script>
                    function changeEvent2(e) {
                        var btnElement = document.getElementById('leaveExportMusterRollReportBtn');
                        if (e == 'on') {
                    ...
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Muster Roll Report</h6><button aria-label="Close" class="btn-close"
                                data-bs-dismiss="modal" type="button" onclick="changeEvent3('off')"><span aria-hidden="true"
                                ...
                                <div class="col-12">
                                    <div class="form-group ">
                                        ...
                                        <div class="custom-controls-stacked d-flex">
                                            <label class="custom-control custom-radio mx-3">
                                                <input type="radio" class="custom-control-input" name="export1"
                                                    onchange="changeEvent3(this.value)" required>
                                                <span class="custom-control-label"><b>Excel</b></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary" type="submit" data-bs-dismiss="modal" id="AttendanceMusterRollBtn" disabled>Export</button>
                        </div>
                    </div>
                </div>
                <script>
                    function changeEvent3(e) {
                        var btnElement = document.getElementById('AttendanceMusterRollBtn');
                        if (e == 'on') {
                            btnElement.removeAttribute('disabled');
                        } else {
                            btnElement.setAttribute('disabled', 'disabled');
        ...
        <form action="{{ route('export.DailyAttendanceReport') }}" method="post">
            ...
            <div class="modal fade" id="export2" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered text-center" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Daily Attendance Report</h6><button aria-label="Close"
                                class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true"
                                    type='reset' onclick="changeEvent4('off')">&times;</span></button>
                        </div>
                        <div class="modal-body">
                                ...
                                <div class="col-12">
                                    <div class="form-group ">
                                        ...
                                        <div class="custom-controls-stacked d-flex">
                                            <label class="custom-control custom-radio mx-3">
                                                <input type="radio" class="custom-control-input" name="export1"
                                                     onchange="changeEvent4(this.value)">
                                                <span class="custom-control-label"><b>Excel</b></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary" data-bs-dismiss="modal" type="submit" id="DailyAttendanceReportBtn1" disabled>Export</button>
                        </div>
                    </div>
                </div>
                <script>
                    function changeEvent4(e) {
                        console.log(e);
                        var btnElement = document.getElementById('DailyAttendanceReportBtn1');
                        if (e == 'on') {
                            btnElement.removeAttribute('disabled');
                        } else {
                            btnElement.setAttribute('disabled', 'disabled');
        ...
        <form action="{{ route('export.EmpAttendanceMusterRoll') }}" method="post">
            ...
            <div class="modal fade" id="export3" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered text-center" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Individual Attendance Report</h6><button type="reset"
                                aria-label="Close" class="btn-close" data-bs-dismiss="modal" onclick="changeEvent5('off')"><span aria-hidden="true"
                                    type='reset'>&times;</span></button>
                        </div>
                        <div class="modal-body">
                            <div class="row text-start">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control header-text" id=""
                                            placeholder="Enter Employee ID" aria-label="text" tabindex="1"
                                            name="empID" required="">
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group ">
                                        ...
                                        <div class="custom-controls-stacked d-flex">
                                            <label class="custom-control custom-radio mx-3">
                                                <input type="radio" class="custom-control-input" name="export1"
                                                     onchange="changeEvent5(this.value)">
                                                <span class="custom-control-label"><b>Excel</b></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary" data-bs-dismiss="modal" type="submit"
                                onclick="modalAction()" id="EmpAttendanceMusterRollBtn" disabled>Export</button>
                        </div>
                    </div>
                </div>
                <script>
                    function changeEvent5(e) {
                        var btnElement = document.getElementById('EmpAttendanceMusterRollBtn');
                        if (e == 'on') {
                            btnElement.removeAttribute('disabled');
                        } else {
                            btnElement.setAttribute('disabled', 'disabled');
        ...
        <form action="{{ route('export.EmpAttendanceMusterRollWithGeoLocation') }}" method="post">
            @csrf
            <div class="modal fade" id="reportWithGeoLocation" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered text-center" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Individual Attendance Report</h6><button type="reset"
                                aria-label="Close" class="btn-close" data-bs-dismiss="modal" onclick="changeEvent6('off')"><span aria-hidden="true"
                                    type='reset'>&times;</span></button>
                        </div>
                        <div class="modal-body">
                            <div class="row text-start">
                                ...
                                <div class="col-12">
                                    <div class="form-group ">
                                        ...
                                        <div class="custom-controls-stacked d-flex">
                                            <label class="custom-control custom-radio mx-3">
                                                <input type="radio" class="custom-control-input" name="export1"
                                                    onchange="changeEvent6(this.value)">
                                                <span class="custom-control-label"><b>Excel</b></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary" data-bs-dismiss="modal" type="submit"
                                onclick="modalAction()" id="EmpAttendanceMusterRollWithGeoLocationBtn" disabled>Export</button>
                        </div>
                    </div>
                </div>
                <script>
                    function changeEvent6(e) {
                        var btnElement = document.getElementById('EmpAttendanceMusterRollWithGeoLocationBtn');
                        if (e == 'on') {
                            btnElement.removeAttribute('disabled');
                        } else {
                            btnElement.setAttribute('disabled', 'disabled');
            ...
            <div class="modal fade" id="export4" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered text-center" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Individual Attendance Report</h6><button type="reset"
                                aria-label="Close" class="btn-close" data-bs-dismiss="modal" onclick="changeEvent7('off')"><span aria-hidden="true"
                                    type='reset'>&times;</span></button>
                        </div>
                        <div class="modal-body">
                            <div class="row text-start">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <p class="form-label">Empployee ID</p>
                                        <input type="text" class="form-control header-text" id=""
                                            placeholder="Enter Employee ID" aria-label="text" tabindex="1"
                                            name="empID" required="">
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group ">
                                        ...
                                        <div class="custom-controls-stacked d-flex">
                                            <label class="custom-control custom-radio mx-3">
                                                <input type="radio" class="custom-control-input" name="export1"
                                                    onchange="changeEvent7(this.value)">
                                                <span class="custom-control-label"><b>Excel</b></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary" data-bs-dismiss="modal" type="submit"
                                onclick="modalAction()" id="EmployeeARReportBtn" disabled>Export</button>
                        </div>
                    </div>
                </div>
                <script>
                    function changeEvent7(e) {
                        var btnElement = document.getElementById('EmployeeARReportBtn');
                        if (e == 'on') {
                            btnElement.removeAttribute('disabled');
                        } else {
                            btnElement.setAttribute('disabled', 'disabled');
