            ...
            <div class="card-body border-bottum-0 m-3">
                <div class="row">
                    ...
                    <div class="col-5 my-auto text-end">
                        <button type="button" class="btn btn-outline-dark my-2" data-bs-toggle="modal" data-bs-target="#clockinmodal" id="newTempFormBtn"><i class="fa fa-file-excel-o me-2"></i>Download</button>
                    </div>
                </div>
            </div>
            <div class="card-body border-bottum-0 m-3">
                <div class="row">
                    ...
                    <div class="col-5 my-auto text-end">
                        <button type="button" class="btn btn-outline-dark my-2" data-bs-toggle="modal" data-bs-target="#clockinmodal" id="newTempFormBtn"><i class="fa fa-pencil me-2"></i>Custmize</button>
                        <button type="button" class="btn btn-outline-dark my-2" data-bs-toggle="modal" data-bs-target="#clockinmodal" id="newTempFormBtn"><i class="fa fa-file-excel-o me-2"></i>Download</button>
                    </div>
                </div>
            </div>
