...
@section('js')
    ...
    <script src="{{ asset('assets/plugins/formwizard/fromwizard.js?v3.31') }}"></script>
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="mt-0 text-start"> <span class="font-weight-semibold">New Employees</span>
                                <h3 class="mb-0 mt-1 text-danger"></h3>
                            </div>
                        </div>
                        <div class="col-5">
                    ...
                    <div class="col-sm-12 text-center d-none" id="regularEmployeeAdddd">
                        ...
                        <div>
                            ...
                            <a class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-bs-target="#"><b><i
                                        class="fa fa-file-excel-o me-1"></i>Upload Bulk</b>
                            </a>
                            <a class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-bs-target="#"><b><i
                                        class="fa fa-file-excel-o me-1"></i>Download Sample Template</b>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 justify-content-center  d-none" id="contractualEmployeeAdd">
                        <div class="row justify-content-center  ">
                            <div class="col-sm-10 justify-content-center">
                                ...
                                <div class="form-group ">
                                    <select id="openAddNewEmployeeMod" name="contractualtype" class="form-control" required>
                            ...
                            <div class="btn-list d-flex">
                                @if (in_array('Employee.Create', $permissions))
                                    <a class="modal-effect btn btn-primary border-0 my-auto" data-effect="effect-scale"
                                        data-bs-toggle="modal" href="#empType">Add New
                                        Employee</a>
                                @endif
                            </div>
                        </div>
                                    ...
                                    <div class="form-group d-flex justify-content-center">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                {{-- <input type="file" id="image_sd" name="image" class="dropify image_sdd"
                                                    data-height="180" /> --}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                {{-- <div class="row">
                                                    <div class="col-md-12"> --}}
                                                <input id="name_sd" type="text" class=" form-control mb-md-0 mb-5"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <p class="form-label">Department</p>
                                                    <div class="form-group mb-3">
                                                        <select id="state-dd1" name="department_id1" class="form-control"
                                                            required>
                                                            <option value="">Select Deparment Name</option>
                                                        </select>
                                                    </div>
    ...
    <div class="modal fade " id="updateempmodal">
        <form action="{{ route('update.employee') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-dialog modal-dialog-scrollable  modal-lg">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">UPDT4 New Employee</h6>
                        <a aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span
                                aria-hidden="true">&times;</span>
                        </a>
                    </div>
                                ...
                                <div id="step-10" class="">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <label id="last_id" class="update_lname_sddd form-label mb-0 mt-2">Last
                                                    Name</label>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <input id="last_sd" type="text"
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-label mb-0 mt-2">State</label>
                                                <select id="" onclick="print_city('state1', this.selectedIndex);"
                                                    name="state"
                                                    class="update_state_sddd sts1 form-control w-100 border rounded"
                                                    required></select>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label mb-0 mt-2">City</label>
                                                <select id="" name="city"
                                                    class="update_city_sddd form-control state1 w-100 border rounded"
                                                    required></select>
                                                <script language="javascript">
                                                    print_state("sts1");
                                                </script>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.get[0].emp_id) {
                        ...
                        // console.log(result.get[0].emp_name);
                        ...
                        $('.update_country_sddd').val(result.get[0].emp_country);
                        $('.update_state_sddd').val(result.get[0].emp_state);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, employee) {
                            ...
                            data-bs-target="#deletemodal${el.emp_id}">
                            <i class="feather feather-trash-2" data-bs-toggle="tooltip"
                                data-original-title="View"></i>
                        </a>`;
                                newRow += '</td></tr>';
            ...
            $('#country-dd1').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        // console.log(result);
                        $('#state-dd1').html(
                            '<option value="" name="department">Se  wire:lect Department Name</option>'
                        );
                        $.each(result.department, function(key, value) {
                            $("#state-dd1").append('<option name="department" value="' +
                                value
                                .depart_id + '">' + value.depart_name +
                                '</option>');
                        });
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#desig-dd').html(
                            '<option value="">Select Designation Name</option>');
                        $.each(res.designation, function(key, value) {
                            $("#desig-dd1").append('<option value="' + value
                                .desig_id + '">' + value.desig_name + '</option>');
                        });
                        // $('#employee-dd').html(
                        //     '<option value="">Select Employee Name</option>');
