                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="my-auto">
                                                        ...
                                                        {{-- <h6 class="mb-1 fs-14 my-auto"><a
                                                                href="{{ route('employeeProfile', ['id' => 1]) }}">{{ $item->emp_name }}</a>
                                                        </h6> --}}
                                                    </div>
                                                </div>
                                            </td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select onchange="print_city('state1', this.selectedIndex);"
                                                                ...
                                                                name="stt"
                                                                class="form-control w-100 border rounded"></select>
                                                        </div>
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="emp_id" type="text" class="form-control"
                                                                placeholder="Employee ID Like: <?=($EmpID->model_id!=null)?$EmpID->model_id:'not create module'?>" value="">
                                                        </div>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select id="state-dd" name="department"
                                                                class="form-control">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select id="city-dd" name="designation"
                                                                class="form-control">
                                                                <option value="">Select Deparment Name</option>
                                                            </select>
                                                            {{-- <select class="form-select" aria-label="Type"
            ...
            $('#country-dd').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $('#city-dd').html(
                            '<option value="" name="designation">Select Designation Name</option>'
                        );
                    }
                });
            });
