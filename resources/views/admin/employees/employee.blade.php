                    ...
                    <div class="page-rightheader ms-auto">
                        <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                            <div class="btn-list d-flex">
                                <a class="modal-effect btn btn-outline-primary border-0 my-auto" data-effect="effect-scale" data-bs-toggle="modal" href="#empType">Add New
                                    Employee</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-footer">
                <button class="btn btn-success" data-bs-dismiss="modal">Online Payment</button> <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#success">Save & Close</button>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="mx-3">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="example-email" class="form-control" placeholder="eg. +91 123456789">
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="custom-switch">
                                        <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input" placeholder="Enter Full Name">
                        ...
                        <label class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="example-checkbox1" value="option1" checked>
                            <span class="custom-control-label"><b>Send SMS Employee</b></span>
                            <span class="fs-11">By continuing you agree to <b><a href="#" class="text-primary">Tearm &
                                        Conditions</a></b></span>
                        </label>
                    </form>
                </div>
...
<div class="modal fade" id="pay" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-footer">
                <button class="btn btn-danger" data-bs-dismiss="modal">Decline</button> <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#success">Confirm</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body d-flex justify-content-around">
                <div class="row">
                    <div class="col-xl-6 text-center">
                        ...
                        <a class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-bs-target="#addempmodal"><b>Add Employee</b></a>
                        <a class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-bs-target="#"><b><i class="fa fa-file-excel-o me-1"></i>Upload Bulk</b></a>
                    </div>
                    <div class="col-xl-6 text-center">
                        <div>
                        ...
                        <a class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-bs-target="#addCotractEmp"><b>Add Employee</b></a>
                        <a class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-bs-target="#"><b><i class="fa fa-file-excel-o me-1"></i>Upload Bulk</b></a>
                    </div>
                </div>
            </div>
