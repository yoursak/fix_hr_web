                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select onchange="print_city('state1', this.selectedIndex);"
                                                            id="sts1" name="state" style="height:50px" name="stt"
                                                            class="form-control w-100 border rounded" required></select>
                                                        {{-- <select class="form-select" aria-label="Type" name="state"
                                                            required>
                                                            <option selected>Select State</option>
                                                            <option value="1">Chhattishgarh</option>
                                            ...
                                            <div class="form-group ">
                                             ...
                                                    
                                                        ...
                                                        {{-- <select class="form-select" aria-label="Type" name="city"
                                                            required>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea rows="3" class="form-control" placeholder="Address2"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-select" aria-label="Type" name="department"
                                                            required>
                                                            @foreach ($Department as $depart)
                                                            <option value="{{$depart->depart_id}}">
                                                                {{$depart->depart_name}}</option>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-select" aria-label="Type" name="designation"
                                                            required>
                                                            @foreach ($Designation as $designation)
                                                            <option value="{{$designation->desig_id}}">
                                                                {{$designation->desig_name}}</option>
