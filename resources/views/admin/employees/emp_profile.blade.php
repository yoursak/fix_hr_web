...
<div class="row">
    @php
    $Details = App\Helpers\Central_unit::EmployeeDetails()->where('emp_id',$id)->first();
    // dd($Details)
    @endphp
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-3">
                    <ul>
                        ...
                        <li class="my-5"><span class="fs-16"><b><i class="fa fa-calendar mx-3"></i>Date of
                                    Joining:</b></span><span class="fs-16 mx-2">{{$Details->emp_date_of_joining}}</span>
                        </li>
                ...
                <div class="col-xl-7 bl">
                    <ul class="ps-4" style="border-left:dashed 2px #97928e;">
                        <li class="my-5"><span class="fs-16"><b><i class="fa fa-phone mx-3"></i>Phone:</b></span><span
                                class="fs-16 mx-2">+91
                        ...
                        <li class="my-5"><span class="fs-16"><b><i
                                ...
                                class="fs-16 mx-2">{{$Details->emp_address}}</span></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card mx-3">
                        <div class="card-body">
                            <ul class="pe-4" style="border-right:dashed 2px #97928e;">
                                ...
                                <li class="my-5"><span class="fs-16"><b>Address:</b></span><span class="fs-16 mx-2">Ring
