    ...
    <div class="row">
        <div class="col-md-2 my-md-5">
            <div class="widget-user-image mt-5 text-center">
                <span class="avatar avatar-md brround me-3 rounded-circle" style="height: 100px; width: 100px; background-image: url('/storage/livewire_employee_profile/{{ $DATA->profile_photo ?? '' }}')"></span>
            </div>
        ...
        <div class="col-md-4 my-md-5">
            <ul class="ps-5">
                ...
                <li class="my-5"><span class="fs-16"><b>{{ $DATA->emp_name ?? '' }}&nbsp;{{ $DATA->emp_mname ?? '' }}&nbsp;{{ $DATA->emp_lname ?? '' }}</b></span><span class="fs-16 mx-2"></span></li>
        ...
        <div class="col-md-4 my-md-5">
            ...
            <ul class="ps-5" style="">
                ...
                <li class="my-5"><span class="fs-16"><b>Address:</b></span><span class="fs-16 mx-2">{{ $DATA->emp_address ?? '' }}</span>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-xl-6"">
        ...
        <div class="card-body ms-xl-5">
            <ul class="pe-4" style="">
                ...
                <li class="my-5"><span class="fs-16"><b>State:</b></span><span class="fs-16 mx-2"> <?= $DATA->StateName ?>
                    </span></li>
                <li class="my-5"><span class="fs-16"><b>City:</b></span> <span class="fs-16 mx-2"><?= $DATA->CityName ?>
                    </span></li>
                <li class="my-5"><span class="fs-16"><b>Zip Code:</b></span><span class="fs-16 mx-2">{{ $DATA->emp_pin_code ?? '' }}</span></li>
                <li class="my-5"><span class="fs-16"><b>Address:</b></span><span class="fs-16 mx-2">{{ $DATA->emp_address ?? '' }}</span></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-body ms-xl-5">
            <ul>
                ...
                <li class="my-5"><span class="fs-16"><b>Assign Setup:</b></span><span class="fs-16 mx-2">{{ $DATA->setup_name ?? '' }}</span></li>
                <li class="my-5"><span class="fs-16"><b>Branch:</b></span><span class="fs-16 mx-2">{{ $DATA->branch_name ?? ' ' }}</span></li>
                <li class="my-5"><span class="fs-16"><b>Department:</b></span><span class="fs-16 mx-2">{{ $DATA->depart_name ?? '' }}</span></li>
                <li class="my-5"><span class="fs-16"><b>Designation:</b></span><span class="fs-16 mx-2">{{ $DATA->desig_name ?? '' }}</span></li>
                <li class="my-5"><span class="fs-16"><b>Shift Type:</b></span><span class="fs-16 mx-2">{{ $DATA->shift_type_name ?? ('' ?? 'Not Allotted') }}</span></li>
                <li class="my-5"><span class="fs-16"><b>Attendance Method:</b></span><span class="fs-16 mx-2">{{ $DATA->method_name ?? '' }}</span></li>
            </ul>
        </div>
    </div>
</div>
