...
@section('content')
    ...
    <div class="modal fade" id="opendEditModelId" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('admin.misspunchapprove') }}" method="post">
                    @csrf
                    <div class="modal-body px-5 ">
                        <input type="text" name="id" id="editMisspunchId" hidden>
                        <input type="text" name="" id="stttttt" hidden>
                        <div class="form-row">
                            <div class="form-group  col-md-4">
                                {{-- <input type="text" name="editMisspunchId" value="" hidden> --}}
                        ...
                        <div class="form-row">
                            <div class="form-group  col-md-3 col-sm-3">
                                ...
                                <input type="date" class="form-control" id="editDate" placeholder="Password"
                                    value="" readonly>
                            </div>
                            <div class="form-group    col-md-3 col-sm-3">
    ...
    <script>
        function openEditModel(context) {
            ...
            $.ajax({
                url: "{{ url('/admin/requests/misspunch/detail') }}",
                type: "POST",
                async: true,
                data: {
                    _token: '{{ csrf_token() }}',
                ...
                success: function(result) {
                    ...
                    if (result.get.id) {
                        ...
                        $('#editTimeType').val(result.get.emp_miss_time_type);
                            ...
                            employee.forEach(el => {
                                ...
                                var newRow = '<tr>' +
                                    ...
                                    `&nbsp;` + el.emp_lname + `</h6>
                                            ...
                                            '<td>' + convert24To12(el.emp_miss_in_time) + '</td>' +
                                            '<td>' + convert24To12(el.emp_miss_out_time) + '</td>' +
