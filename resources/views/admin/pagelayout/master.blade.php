                    ...
                    <div class="predefined_styles">
                        ...
                        <div class="swichermainleft">
                            ...
                            <div class="skin-body switch_section">
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <a class="bg-img1" href="javascript:void(0);"><img src={{ asset('assets/images/photos/bg-img1.jpg') }} alt="Bg-Image" id="bgimage1"></a>
                                    <a class="bg-img2" href="javascript:void(0);"><img src={{ asset('assets/images/photos/bg-img2.jpg') }} alt="Bg-Image" id="bgimage2"></a>
                                    <a class="bg-img3" href="javascript:void(0);"><img src={{ asset('assets/images/photos/bg-img3.jpg') }} alt="Bg-Image" id="bgimage3"></a>
                                    <a class="bg-img4" href="javascript:void(0);"><img src={{ asset('assets/images/photos/bg-img4.jpg') }} alt="Bg-Image" id="bgimage4"></a>
                                </div>
                            </div>
                        </div>
                        <div class="swichermainleft">
