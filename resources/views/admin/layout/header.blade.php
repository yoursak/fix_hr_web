    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            <a class="header-brand" href="{{ url('/dashboard') }}" style="text-align: center">
                <img src={{ asset('assets/logo/FixHR.png?v=0.1') }} class="header-brand-img desktop-lgo"
                    alt="FixingDotslogo" style="height: 4rem;  margin: auto;">
                <img src={{ asset('assets/logo/Fix_HR_Dark.png') }} class="header-brand-img dark-logo"
                    alt="FixingDotslogo" style="height: 4rem;  margin: auto;">
                <img src="{{ asset('assets/logo/FixHR.png?v=0.1') }}" class="header-brand-img mobile-logo"
                    alt="FixingDotslogo">
                <img src="{{ asset('assets/logo/Fix_HR_Dark.png') }}" class="header-brand-img darkmobile-logo"
                    alt="FixingDotslogo">
            </a>
                        ...
                        <div class="d-flex ms-auto justify-content-start">
                            ...
                            <div class="d-flex" style="transform: translateX(20px);">
                                ...
                                <div class="dropdown header-notify my-auto ms-5">
                                    ...
                                    <div class="me-3 mt-0 mt-sm-1 d-block text-center">
                                        <span class="fs-14 mb-0"><b>{{ Session::get('login_name') }}</b></span><br>
