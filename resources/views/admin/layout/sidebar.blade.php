        ...
        <div class="app-sidebar__logo">
            <a class="header-brand" href="index.html">
                ...
                <a href="{{ url('/dashboard') }}" style="display: flex; justify-content: center; align-items: center;">
                    <img src="{{ asset('assets/logo/Fix_HR_Dark.png?v=0.10') }}" class="header-brand-img dark-logo" style="transform: translateY(-5px); max-width: 70%;" alt="FixingDotslogo">
                </a>
                <img src="{{ asset('assets/logo/Fix_HR_Dark.png?v=0.10') }}" class="header-brand-img mobile-logo" alt="FixingDotslogo">
                <img src="{{ asset('assets/logo/Fix_HR_Dark.png?v=0.10') }}" class="header-brand-img darkmobile-logo" alt="FixingDotslogo">
            </a>
        </div>
            ...
            <div class="main-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu" style="background-color:  #1034A6; border-radius:7px;">
                        ...
                        <li><a href="{{ url('/admin/requests/leaves/balance') }}" class="slide-item"> Leave Balance </a></li>
                        ...
                        <li><a href="{{ url('/admin/requests/outdoor') }}" class="slide-item">Outdoor </a></li>
                ...
                <li><a href="{{ url('admin/settings/attendance') }}" class="slide-item"> Attendance Settings</a></li>
                <li><a href="{{ url('admin/settings/tada') }}" class="slide-item"> TADA Settings</a></li>
                <li><a href="{{ url('admin/settings/tadasettings') }}" class="slide-item">Travel & Daily Allowance</a></li>
                <li><a href="{{ url('admin/settings/payroll') }}" class="slide-item">Payroll Settings</a></li>
            ...
            <?php } else { ?>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu" style="background-color: #1034A6; border-radius: 7px;">
                        @foreach ($subItems1 as $subItem)
                        @if (in_array($subItem['label'], $permissions))
                        <li><a href="{{ url($subItem['url']) }}" class="slide-item">{{ $subItem['name'] }}</a></li>
                        @endif
                        @endforeach
                    </ul>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        <i class="feather feather-file-text sidemenu_icon"></i>
                        <span class="side-menu__label">Roles & Permissions</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu" style="background-color: #1034A6; border-radius: 7px;">
                        @foreach ($subItems as $subItem)
                        @if (in_array($subItem['label'], $permissions))
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu" style="background-color: #1034A6; border-radius: 7px;">
                        ...
                        <li>
                            ...
                            @endphp
                            <a href="{{ url($firstMatchingItem['url']) }}" class="slide-item">{{ $uniqueName }}</a>
                        </li>
                        @endforeach
                    </ul>
                </li>
