    ...
    <div class="page responsive-log coming-bg">
        <div class="page-content p-7 m-0">
            <div class="container text-center">
                <div class="display-2 mb-5 font-weight-semibold">Welcome to <span style="color: #0000ff"><b>FixHR</b></span>
                </div>
                <h1 class="h3  mb-3">Make Your Human Resource Online</h1>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-4">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="eg. +91 xxxxx xxx58">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
