            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-primary d-flex justify-content-end" value="1" type="button" id="addButton"
                            onclick="hide_data(this.value);array_data(this.value);"
                    ...
                    <div class="row p-0 m-0">
                        ...
                        <div class="col-xl-2">
                            <div class="form-group select2-lg">
                                <label for="field-3" class="form-label"><span style="font-size:15px;" id="">Travel
                        ...
                        <div class="col-xl-2" id="country_0">
                            <div class="form-group select2-lg">
                                <div class="">
                                    <label for="field-3" class="form-label"><span
                                            style="font-size:15px;">Country</span><span style="color:red">*</span><span
                                            style="font-size:14px; color:black"> :</span></label>
                    ...
                    <div class="col-xl-1">
                        ...
                        <div class="col-xl-2" id="city_0"> --}}
                            ...
                            {{-- <div class="">
                                <label for="field-3" class="form-label"><span style="font-size:15px;">City</span><span
                                        style="color:red">*</span><span style="font-size:14px; color:black">
                                        :</span></label>
                                <select class="SlectBox-grp-src" >
                                    <option>Select</option>
                            ...
                            {{-- <div class="form-group">
                                ...
                                <select class="form-control select2 custom-select select2-hidden-accessible" name="shiftsetting[]" data-placeholder="Choose Shift Policy" multiple="" required="" tabindex="-1" aria-hidden="true" id="city_qs">
                                    <option label="Choose Shift Policy"></option>

                                        {{-- <option value="45"> 2&nbsp;|&nbsp; Rotational Shift&nbsp;</option>
                                        <option value="46"> 3&nbsp;|&nbsp; Infinite Open Shift&nbsp;</option>
                                        <option value="132">4&nbsp;|&nbsp; Open Shift&nbsp;</option> --}}
                                {{-- </select>
                            </div> -- --}}
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <div class="SumoSelect"  id="city_qs" tabindex="0" role="button" aria-expanded="true">
                                        <select
                                            multiple="multiple" class="testselect2 SumoUnder" tabindex="-1">
                        ...
                        <div class="col-xl-1 p-0">
                            <div class="col-md-1"><button class="btn btn-danger" type="button"
                                    id="removeButton_' + cloneCount + '" onclick="deleteRow_first(this)"
    ...
    <script>
        ...
        function array_data(value) {
            ...
            $('#add_row').append(
                ...
                '</div>' +
                '<div class="col-xl-1 p-0">' +
                '<div class="col-md-1"><button class="btn btn-danger" type="button" id="removeButton_' + no +
                '" onclick="deleteRow(this)"  >X</button></div>' +
                '</div>' +
                '</div>'
            );
        ...
        function change_state(val) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var selOpts1 = "<option value='' >Select Model</option>";
                    // if (Array.isArray(response)) {
                    response.city.forEach(function(data) {
                        console.log('data:',
                            data); // Log each individual data object to inspect its structure
                        // if (data && data.name) {
                    ...
                    // $('#city_qs').html(selOpts1);
                    document.getElementById('city_qs').innerHTML = selOpts1;
                    //  $('#city_qs').trigger('change');
                },
