...
<div class="page responsive-log error-bg1">
    ...
    <div class="page-content m-0">
        <div class="container text-center relative">
            <div class="display-1 text-white mb-5 font-weight-semibold"> 4<i class="fa fa-frown-o"></i>2</div>
            <h1 class="h3  mb-3 font-weight-semibold text-white-80"> Request cannot be processed </h1>
