...
<div class="page responsive-log error-bg1">
    <div class="page-content m-0">
        <div class="container text-center relative">
            ...
            <h1 class="h3  mb-3 font-weight-semibold text-white-80">Sorry an error has occured Service Unavaliable </h1>
            ...
            <a class="btn btn-danger" href="https://phplaravel-1083191-3790162.cloudwaysapps.com/subscription"><i class="fe fe-arrow-left-circle me-1"></i>Back to Home</a>
        </div>
    </div>
</div>
@endsection