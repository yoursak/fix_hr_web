<div>
    ...
    <div id="p3" class="form-group form-row">
        <form action="{{ route('approval_submit') }}" method="POST">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group row m-4">
                        ...
                        <div class="col-sm-5">
                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                <input type="radio" class="btn-check" name="btnradio" id="btnradiomonthlm3" value="1"
                                    checked>
                                <label class="btn btn-outline-primary" for="btnradiomonthlm3">Sequential
                                    {{-- (Chain) --}}
                                </label>
                                <input type="radio" class="btn-check" name="btnradio" id="btnradioyearlm3" value="2">
                ...
                <div class="text-end">
                    ...
                    <button type="button" class="btn btn-outline-primary add_item_btnlm1"><i class="fe fe-plus bold"></i>
                    </button>
                </div>
                <div class="row ">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //     $('#show_item_lm1').each(function(index, element) {
            ...
            //     //     url: postURL,
            //     //     method: "POST",
            //     //     data: $('#add_item_btnlm1').serialize(),
            //     //     type: 'json',
            //     //     // dd(data);
        ...
        $(document).ready(function() {
                ...
                success: function(get) {
                    ...
                    // console.log("g3et data ",get.data);
