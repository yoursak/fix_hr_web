<div>
    ...
    <div class=" p-0 pt-2 pb-5">
        <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
            ...
            <li class="active"><span><b>Daily Allowance Policy</b></span></li>
        </ol>
    </div>
    <div class="card">
            ...
            @foreach ($increase as $key => $value)
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-2  col-xxl-2">
                        <div class="form-group">
                            <div class="form-group">
                                <label class="form-label">Travel &nbsp;<i class="fa fa-info-circle" style="font-size:15px" data-bs-toggle="tooltip" data-bs-placement="top" title="Travel Type"></i></label>
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-1 col-xxl-1">
                        <div class="form-group">
                            <div class="form-group">
                                <label class="form-label">Limit Test</label>
                                {{-- wire-click="lodging_limit" --}}
                                <select class="form-control" wire:model="lodging_limit.{{ $key }}"
                                    wire:change="lodging_limit_action({{ $value }})">
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-2 col-xxl-2">
                        <div class="form-group">
                            <div class="form-group">
                                <label class="form-label">Singal Occupancy</label>
                    ...
                    <div
                        class="col-sm-12 col-12 col-xl-1 col-xxl-1 mt-3 mt-md-0 d-flex justify-content-end align-items-center">
