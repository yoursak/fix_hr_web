...
@endphp
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card p-4">
                @livewire('power-grid.employee-page-table', ['tableName' => 'languages'])
                            ...
                            <div class="btn-list d-flex">
                                @if (in_array('Employee.Create', $permissions))
                                    <a class="modal-effect btn btn-primary border-0 my-auto" data-effect="effect-scale"
                                        data-bs-toggle="modal" href="#empTypeComponent">Add New
                                        Employee</a>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 text-center d-none" id="regularEmployeeAdddd">
                        ...
                        <div>
                            <a type="button" class="modal-effect btn btn-outline-primary my-2 border-0"
                                ...
                                data-bs-target="#newStudentModalLabel"><b> Add
                                    Employee</b></a>
                    ...
                    <div class="col-sm-12 justify-content-center  d-none" id="contractualEmployeeAdd">
                        ...
                        <div class="text-center">
                            <a class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal"
                                data-bs-target="#"><b>Add Employee</b></a>
                            <a class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" data-bs-toggle="modal" data-bs-target="#deleteStudentModal"
                                wire:click="deleteStudent({{ $student->id }})" class="btn btn-danger">Delete</button>
                        </td>
                    </tr>
                    @empty
                    <tr>
                                ...
                                <div id="step-10" class="">
                                    ...
                                    <div class="form-group d-flex justify-content-center">
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="file" id="image_sd" name="image"
                                                    class="image_sdd " data-default-file="" data-height="60"
                                                    data-width="100" data-min-width="100" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input id="number_sd" type="tel"
                                                    ...
                                                    name="update_mobile_number" maxlength="10" pattern="[0-9]{10}"
                                                    required>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label mb-0 mt-2">Email</label>
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-label mb-0 mt-2">Date Of Birth</label>
                                                <input type="date"
                                                    class="update_dob_sddd form-control fc-datepicker"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row pt-5">
                                            <div class="col-md-4">
                                                ...
                                                {{-- <select class="form-control update_nationality_sddd"
                                                    name="nationality_dd" aria-label="Type" id="nationality_dd"
                                                    name="nationality_dd" required>
                                                    <option value="">Select Nationality</option>
                                                    <option value="1">India</option>
                                                    <option value="2">USA</option>
                                    ...
                                    <div class="form-group mb-0 justify-content-end">
                                        ...
                                        <div class="row pt-5">
                                            ...
                                            <div class="col-md-4" id="select_rotational_div">
                                                <label class="form-label mb-0 mt-2">Select Rotational Type</label>
                                                <select name="update_rotational_type" id="roatational_type_id"
                                                    aria-label="Type"
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-label mb-0 mt-2">Assign Attendance
                                                    Mathod</label>
                                                <select name="update_attendance_method" aria-label="Type"
                                                    id="attendance_sd"
                                                    class="update_attendance_method form-control custom-select"
                                                    required>
                                                    <option label="Select Type" value="">Select Attendence
                                                        Mark
                                                        Type
                                                    </option>
                                                    @foreach ($attendanceMethod as $assign_attendance)
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-label mb-0 mt-2">Assign Setup</label>
                                                <select name="edit_assign_setup" aria-label="Type"
                                                    id="edit_assign_setup"
                                                    class="form-control update_edit_assign_setup custom-select"
                                                    required>
                                                    <option label="Select Type" value="">Select Assign Setup
                                                    </option>
                                                    @foreach ($setupAssociated as $assign_setup)
