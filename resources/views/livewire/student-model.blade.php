                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class=" row ">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label mb-0 mt-2">Employee ID<span class="text-danger">*</span> <a wire:click="getGenerateEmpID" class="p-0 btn btn-primary btn-sm">EmpId
                                            A.I.</a></label>
                                    <input name="" id="" type="text" wire:keyup="newEmployeeValidation" wire:change="newEmployeeJoiningValidation" class=" form-control" wire:model.live="generate_emp_id" wire:model="generate_emp_id" placeholder="Employee ID Like: <?= $generate_emp_id != null ? '99' : ' not create module' ?>">
                                    <span class="text-error-danger">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label mb-0 mt-2">Reporting Manager<span class="text-danger">*</span></label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="new_ifsc_code" placeholder="Enter Ifsc Code" wire:model="new_ifsc_code" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                            @error('new_ifsc_code')
                                            {{ $message }}
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="new_bank_name" placeholder="Enter Bank Name" wire:model="new_bank_name" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                            @error('new_bank_name')
                                            {{ $message }}
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="new_branch_name" placeholder="Enter Branch Name" wire:model="new_branch_name" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="new_branch_code" placeholder="Enter Branch Code" wire:model="new_branch_code" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" name="new_bank_accountno" placeholder="Enter Bank Account No." wire:model="new_bank_accountno" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" name="new_micr_code" placeholder="Enter Micr Code" wire:model="new_micr_code" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                            @error('new_micr_code')
                                            {{ $message }}
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" class="form-control" name="new_bank_address_line1" placeholder="Enter Address Line 1 without State,City & Pincode" wire:model="new_bank_address_line1" wire:keyup="validateData"></textarea>
                                        <span class="text-error-danger">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" class="form-control" name="new_bank_address_line2" placeholder="Enter Address Line 2 without State,City & Pincode" wire:model="new_bank_address_line2" wire:keyup="validateData"></textarea>
                                        <span class="text-error-danger">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="form-label mb-0 mt-2">Grade<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="new_grade" placeholder="Enter Grade " wire:model="new_grade" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                            @error('new_grade')
                                            {{ $message }}
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label mb-0 mt-2">Budget Code<span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="new_budget_code" placeholder="Enter Budget Code" wire:model="new_budget_code" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" name="new_account_code" placeholder="Enter Account Code" wire:model="new_account_code" wire:keyup="validateData">
                                        <span class="text-error-danger">
        ...
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body  justify-content-around">
                <div class="row justify-content-center  ">
                    <div class="col-sm-10 justify-content-center">
                        ...
                        <div class="form-group">
                            <select id="openAddNewEmployeeMod" wire:model="employee_type" name="employee_type" class="form-control">
                                <option value="" selected>Select Employee Type</option>
                                @foreach ($getEmpType as $item)
                                <option value="<?= $item->type_id ?>"><?= $item->emp_type ?></option>
                                @endforeach
            ...
            <div>
                <div class="col-sm-12 text-center d-none" id="regularEmployeeAdddd">
                    ...
                    <div>
                        <a type="button" class="modal-effect btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-effect="effect-scale" data-bs-target="#newStudentModal"><b>
                                Add
                                Employee</b></a>
                        {{-- <a class="modal-effect btn btn-outline-primary my-2 border-0" id="btnXyz"
                            data-effect="effect-scale" data-bs-toggle="modal" href="#newStudentModalLabel"><b> Add
                                Employee</b></a> --}}
                        <a href="{{ url('admin/employee/export_file/1') }}" class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-bs-target="{{ url('admin/employee/export_file') }}"><b><i class="fa fa-file-excel-o me-1"></i>Download
                                Sample Template</b>
                        </a>
                        <form action="{{ url('admin/employee/import_file') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="col-sm-12 justify-content-center  d-none" id="contractualEmployeeAdd">
                    <div class="row justify-content-center  ">
                        <div class="col-sm-10 justify-content-center">
                            ...
                            <div class="form-group ">
                                <select id="ContractType" wire:model="employee_contractual_type" name="contractualtype" class="form-control">
                    ...
                    <div class="text-center">
                        <a type="button" class="modal-effect btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-effect="effect-scale" data-bs-target="#newStudentModal"><b>
                                Add
                                Employee</b></a>
                        <a href="{{ url('admin/employee/export_file/2') }}" class="btn btn-outline-primary my-2 border-0" data-bs-toggle="modal" data-bs-target="{{ url('admin/employee/export_file/2') }}"><b><i class="fa fa-file-excel-o me-1"></i>Download
                                Sample Template</b>
                        </a>
                        <form action="{{ url('admin/employee/import_file') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class=" row ">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label mb-0 mt-2">Reporting Manager<span class="text-danger">*</span></label>
                                    <input type="text" wire:keyup="validateData" class="form-control " wire:model="report_manager">
                                    <span class="text-error-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="form-label mb-0 mt-2">Grade<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="update_grade" placeholder="Enter Grade " wire:model="update_grade" wire:keyup="validateData">
                                        <span class="text-error-danger">
                                            @error('update_grade')
                                            {{ $message }}
                                            @enderror
